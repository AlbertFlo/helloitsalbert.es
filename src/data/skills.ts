...
export const skills: Skill[] = [
    ...
    },
    {
        ...
        contentDescription:
            "WCAG 2.1/2.2, WAI-ARIA, cross-browser compatibility, and Cypress E2E testing, delivering quality that holds up in the real world. I integrate automated testing into CI pipelines and conduct manual accessibility audits to ensure every interface is inclusive, robust, and production-ready before it ever reaches a user.",
